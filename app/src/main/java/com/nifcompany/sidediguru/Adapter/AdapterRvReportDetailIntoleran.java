...
public class AdapterRvReportDetailIntoleran extends RecyclerView.Adapter<AdapterRvReportDetailIntoleran.ListViewHolder> {

    private List<StudentsItem> listItem;
    private OnItemClickCallBackReport onItemClickCallBackReport;

    public AdapterRvReportDetailIntoleran(List<StudentsItem> listKecNegatif) {
            this.listItem = listKecNegatif;
    }
    ...
    public void onBindViewHolder(@NonNull final ListViewHolder listViewHolder, final int i) {
        listViewHolder.tvQuestion.setText(listItem.get(i).getStudentName());
    ...
    class ListViewHolder extends RecyclerView.ViewHolder {
        ...
        ListViewHolder(@NonNull View itemView) {
            super(itemView);
            tvQuestion = itemView.findViewById(R.id.TvReportDetail);
        }
    }
}
