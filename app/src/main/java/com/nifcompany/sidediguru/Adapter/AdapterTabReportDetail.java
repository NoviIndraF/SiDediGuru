...
public class AdapterTabReportDetail extends FragmentPagerAdapter {

    private final Context mContext;

    public AdapterTabReportDetail(Context context, FragmentManager fm) {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                fragment = new FragmentReportDetailToleran();
                break;
            case 1:
                fragment = new FragmentReportDetailIntoleran();
                break;
        }
        return fragment;
    }
